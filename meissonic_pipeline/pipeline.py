...
# print("==========================")
# print("hidden_states:", model_input.shape, model_input.dtype)
# print("micro_conds", micro_conds.shape, micro_conds.dtype)
# print("pooled_projections", prompt_embeds.shape, prompt_embeds.dtype)
# print("encoder_hidden_states", encoder_hidden_states.shape, encoder_hidden_states.dtype)
# print("img_ids",img_ids.shape , img_ids.dtype)
# print("txt_ids", txt_ids.shape, txt_ids.dtype)
# tmstp = torch.tensor([timestep], device=model_input.device, dtype=torch.long)
# print("timestep", tmstp.shape, tmstp.dtype)
# print("==========================")